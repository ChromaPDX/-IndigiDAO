...
// https://github.com/nibbstack/erc721/blob/master/src/contracts/tokens/nf-token-enumerable.sol
...
contract ERC721DropRedeemableEnumerableGettableMint is
    ERC721Drop,
    IERC721Enumerable
{
    constructor(
    ...
    // function getTokenIds() public view returns (Id2Uri[] memory) {
    //     uint256 lngth = ERC721A.totalSupply();
    //     Id2Uri[] memory _metadatasOfOwners = new Id2Uri[](lngth);

    //     uint256 i;
    //     for (i = 0; i < lngth; i++) {
    //         uint tUid = tokenByIndex(i);
